...
const CreateNewArticle = () => {
  ...
  const submitForm = (data) => {
    ...
    fetchArticleCreate({ article: { ...data, tagList: tags } }, token).then((response) => {
  ...
  return (
    <div className="wrapper-form">
      <div className="form-container">
        ...
        <form className="form" id="article-create-form" onSubmit={handleSubmit(submitForm)}>
        ...
        <input className="button" type="submit" value="Send" form="article-create-form" />
